...
6/ Install the DB from the script i.e run the scripts in web/src/main/resources/schema as root. Note uncomment the DELIMITER statement. The scripts can also be run by following the instructions in the /web application.properties
