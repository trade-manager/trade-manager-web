...
$mvn clean install (make sure $JAVA_HOME is version 1.8, check with $>echo $JAVA_HOME)
...
8/ Open IntelliJ and import the parent pom.xml from the project dir. You can now set run configurations for 6/ and 7/ 
