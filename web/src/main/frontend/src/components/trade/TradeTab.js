...
function TradeTab(props) {
  ...
  const { isTradingdaysLoading, tradingdays, tradingdayOpen, tradingdayClose, tradingdayMktGap, tradingdayMktBias, tradingdayMktBar, tradingdayOpenSearch, tradingdayCloseSearch, handleAddTradingday, handleDeleteTradingday, handleSearchTradingday } = props
  const { isTradestrategiesLoading, tradestrategies, tradestrategyId, tradestrategyDate, tradestrategyTrade, tradestrategySymbol, tradestrategySide, tradestrategyTier, tradestrategyStrategy, tradestrategyStrategyMgr, tradestrategyPortfolio, tradestrategyBarSize, tradestrategyChartDays, tradestrategySymbolSearch, handleAddTradestrategy, handleDeleteTradestrategy, handleSearchTradestrategy } = props
