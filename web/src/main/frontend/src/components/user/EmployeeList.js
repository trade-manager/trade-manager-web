...
import {Form, Grid, Header, Icon, Input, Item, Segment} from 'semantic-ui-react'
            ...
            return (
                <Item key={employee.id}>
                    <Item.Content>
                        ...
                        <Item.Description>First name : {employee.firstName} Last
                            name: {employee.lastName} Email: {employee.email}</Item.Description>
                    </Item.Content>
                </Item>
            )
        })
