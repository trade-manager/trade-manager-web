...
import org.trade.indicator.atr.AverageTrueRangeItemUI;
...
public class AverageTrueRangeSeriesUI extends IndicatorSeriesUI {
     ...
     */
    public AverageTrueRangeSeriesUI(Strategy strategy, String name, String type, String description,
    ...
    public AverageTrueRangeSeriesUI() {
        super(IndicatorSeriesUI.AverageTrueRangeSeries);
    }
    ...
    public RegularTimePeriod getPeriod(int index) {
        final AverageTrueRangeItemUI item = (AverageTrueRangeItemUI) getDataItem(index);
    ...
    public void add(RegularTimePeriod period, BigDecimal averageTrueRange) {
        if (!this.isEmpty()) {
            AverageTrueRangeItemUI item0 = (AverageTrueRangeItemUI) this.getDataItem(0);
            if (!period.getClass().equals(item0.getPeriod().getClass())) {
                throw new IllegalArgumentException("Can't mix RegularTimePeriod class types.");
            }
        }
        super.add(new AverageTrueRangeItemUI(period, averageTrueRange), true);
    }
     ...
     */
    public void add(AverageTrueRangeItemUI dataItem, boolean notify) {
        if (!this.isEmpty()) {
            AverageTrueRangeItemUI item0 = (AverageTrueRangeItemUI) this.getDataItem(0);
        ...
        if (source.getItemCount() > skip) {
            ...
            if (source.getItemCount() > 1) {
                ...
                if (skip >= getLength() - 1) {
                    ...
                    if (newBar) {
                        AverageTrueRangeItemUI dataItem = new AverageTrueRangeItemUI(candleItem.getPeriod(),
                                new BigDecimal(currATR));
                        this.add(dataItem, false);

                    } else {
                        AverageTrueRangeItemUI dataItem = (AverageTrueRangeItemUI) this
    ...
    public void printSeries() {
        for (int i = 0; i < this.getItemCount(); i++) {
            AverageTrueRangeItemUI dataItem = (AverageTrueRangeItemUI) this.getDataItem(i);
