 ...
 */
public class RelativeStrengthIndexSeriesUI extends IndicatorSeriesUI {
     ...
     */
    public RelativeStrengthIndexSeriesUI(Strategy strategy, String name, String type, String description,
    ...
    public RelativeStrengthIndexSeriesUI() {
        super(IndicatorSeriesUI.RelativeStrengthIndexSeries);
    }
    ...
    public RegularTimePeriod getPeriod(int index) {
        final RelativeStrengthIndexItemUI item = (RelativeStrengthIndexItemUI) getDataItem(index);
    ...
    public void add(RegularTimePeriod period, BigDecimal relativeStrengthIndex) {
        if (!this.isEmpty()) {
            RelativeStrengthIndexItemUI item0 = (RelativeStrengthIndexItemUI) this.getDataItem(0);
            if (!period.getClass().equals(item0.getPeriod().getClass())) {
                throw new IllegalArgumentException("Can't mix RegularTimePeriod class types.");
            }
        }
        super.add(new RelativeStrengthIndexItemUI(period, relativeStrengthIndex), true);
    }
     ...
     */
    public void add(RelativeStrengthIndexItemUI dataItem, boolean notify) {
        if (!this.isEmpty()) {
            RelativeStrengthIndexItemUI item0 = (RelativeStrengthIndexItemUI) this.getDataItem(0);
    ...
    public void updateSeries(CandleSeriesUI source, int skip, boolean newBar) {
        ...
        if (source.getItemCount() > skip) {
            ...
            if (skip >= getLength()) {
                ...
                if (newBar) {
                    RelativeStrengthIndexItemUI dataItem = new RelativeStrengthIndexItemUI(candleItem.getPeriod(),
                            new BigDecimal(currentRSI));
                    this.add(dataItem, false);
                } else {
                    RelativeStrengthIndexItemUI dataItem = (RelativeStrengthIndexItemUI) this
    ...
    public void printSeries() {
        for (int i = 0; i < this.getItemCount(); i++) {
            RelativeStrengthIndexItemUI dataItem = (RelativeStrengthIndexItemUI) this.getDataItem(i);
