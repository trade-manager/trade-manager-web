...
import org.trade.indicator.mfi.MoneyFlowIndexItemUI;
...
public class MoneyFlowIndexSeriesUI extends IndicatorSeriesUI {
     ...
     */
    public MoneyFlowIndexSeriesUI(Strategy strategy, String name, String type, String description, Boolean displayOnChart,
    ...
    public MoneyFlowIndexSeriesUI() {
        super(IndicatorSeriesUI.MoneyFlowIndexSeries);
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        MoneyFlowIndexSeriesUI clone = (MoneyFlowIndexSeriesUI) super.clone();
    ...
    public RegularTimePeriod getPeriod(int index) {
        final MoneyFlowIndexItemUI item = (MoneyFlowIndexItemUI) getDataItem(index);
     ...
     * @param moneyFlowIndex the moneyFlowIndex.
     */
    public void add(RegularTimePeriod period, BigDecimal moneyFlowIndex) {
        if (!this.isEmpty()) {
            MoneyFlowIndexItemUI item0 = (MoneyFlowIndexItemUI) this.getDataItem(0);
            if (!period.getClass().equals(item0.getPeriod().getClass())) {
                throw new IllegalArgumentException("Can't mix RegularTimePeriod class types.");
            }
        }
        super.add(new MoneyFlowIndexItemUI(period, moneyFlowIndex), true);
    }
     ...
     */
    public void add(MoneyFlowIndexItemUI dataItem, boolean notify) {
        if (!this.isEmpty()) {
            MoneyFlowIndexItemUI item0 = (MoneyFlowIndexItemUI) this.getDataItem(0);
    ...
    public void updateSeries(CandleSeriesUI source, int skip, boolean newBar) {
        ...
        if (source.getItemCount() > skip) {
            if (source.getItemCount() > 1) {
                ...
                CandleItemUI prevCandleItem = (CandleItemUI) source.getDataItem(skip - 1);
                ...
                if (0 != candleItem.getClose()) {
                    ...
                    if (this.yyValues.size() == this.getLength()) {
                        ...
                        if (newBar) {
                            MoneyFlowIndexItemUI dataItem = new MoneyFlowIndexItemUI(candleItem.getPeriod(),
                                    new BigDecimal(mfi));
                            this.add(dataItem, false);

                        } else {
                            MoneyFlowIndexItemUI dataItem = (MoneyFlowIndexItemUI) this
    ...
    public void printSeries() {
        for (int i = 0; i < this.getItemCount(); i++) {
            MoneyFlowIndexItemUI dataItem = (MoneyFlowIndexItemUI) this.getDataItem(i);
