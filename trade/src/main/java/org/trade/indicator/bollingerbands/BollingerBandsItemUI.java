 ...
 * @since 1.0.4
 */
public class BollingerBandsItemUI extends ComparableObjectItem {
     ...
     */
    public BollingerBandsItemUI(RegularTimePeriod period, BigDecimal bollingerBands) {
