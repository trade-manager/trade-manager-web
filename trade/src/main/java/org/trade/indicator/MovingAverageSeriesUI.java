 ...
 */
public class MovingAverageSeriesUI extends IndicatorSeriesUI {
    ...
    public Object clone() throws CloneNotSupportedException {
        MovingAverageSeriesUI clone = (MovingAverageSeriesUI) super.clone();
    ...
    public RegularTimePeriod getPeriod(int index) {
        final MovingAverageItemUI item = (MovingAverageItemUI) getDataItem(index);
    ...
    public void add(RegularTimePeriod period, BigDecimal movingAverage) {
        if (!this.isEmpty()) {
            MovingAverageItemUI item0 = (MovingAverageItemUI) this.getDataItem(0);
            if (!period.getClass().equals(item0.getPeriod().getClass())) {
                throw new IllegalArgumentException("Can't mix RegularTimePeriod class types.");
            }
        }
        super.add(new MovingAverageItemUI(period, movingAverage), true);
    }
     ...
     */
    public void add(MovingAverageItemUI dataItem, boolean notify) {
        if (!this.isEmpty()) {
            MovingAverageItemUI item0 = (MovingAverageItemUI) this.getDataItem(0);
        ...
        if (source.getItemCount() > skip) {
            ...
            if (0 != candleItem.getClose()) {
                ...
                if (this.yyValues.size() == getLength()) {
                    ...
                    if (newBar) {
                        MovingAverageItemUI dataItem = new MovingAverageItemUI(candleItem.getPeriod(), new BigDecimal(ma));
                        this.add(dataItem, false);

                    } else {
                        MovingAverageItemUI dataItem = (MovingAverageItemUI) this.getDataItem(this.getItemCount() - 1);
    ...
    public void printSeries() {
        for (int i = 0; i < this.getItemCount(); i++) {
            MovingAverageItemUI dataItem = (MovingAverageItemUI) this.getDataItem(i);
     ...
     * @return double
     */
    private double getPrice(CandleItemUI candle) {
