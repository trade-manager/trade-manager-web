 ...
 *
 */
package org.trade.indicator.heikinashi;
 ...
 * @since 1.0.4
 */
public class HeikinAshiItemUI extends ComparableObjectItem {
     ...
     */
    public HeikinAshiItemUI(Contract contract, RegularTimePeriod period, double open, double high, double low,
