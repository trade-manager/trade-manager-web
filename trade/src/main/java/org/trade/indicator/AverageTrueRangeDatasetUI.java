...
import org.trade.indicator.atr.IAverageTrueRangeDatasetUI;
 ...
 *
 */
public class AverageTrueRangeDatasetUI extends AbstractXYDataset
        implements IIndicatorDatasetUI, IAverageTrueRangeDatasetUI, Serializable {
     ...
     */
    public AverageTrueRangeDatasetUI() {
     ...
     */
    public AverageTrueRangeSeriesUI getSeries(int series) {
        if ((series < 0) || (series >= getSeriesCount())) {
            throw new IllegalArgumentException("Series index out of bounds");
        }
        return (AverageTrueRangeSeriesUI) this.data.get(series);
    }
    ...
    public double getXValue(int series, int item) {
        AverageTrueRangeSeriesUI s = (AverageTrueRangeSeriesUI) this.data.get(series);
        AverageTrueRangeItemUI di = (AverageTrueRangeItemUI) s.getDataItem(item);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AverageTrueRangeDatasetUI that)) {
            return false;
        }
    ...
    public Object clone() throws CloneNotSupportedException {
        AverageTrueRangeDatasetUI clone = (AverageTrueRangeDatasetUI) super.clone();
    ...
    public void updateDataset(CandleDatasetUI source, int seriesIndex, boolean newBar) {
        ...
        for (int x = 0; x < this.getSeriesCount(); x++) {
            AverageTrueRangeSeriesUI series = this.getSeries(x);
