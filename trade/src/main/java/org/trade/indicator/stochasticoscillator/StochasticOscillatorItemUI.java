 ...
 * @since 1.0.4
 */
public class StochasticOscillatorItemUI extends ComparableObjectItem {
     ...
     */
    public StochasticOscillatorItemUI(RegularTimePeriod period, BigDecimal stochasticOscillator) {
