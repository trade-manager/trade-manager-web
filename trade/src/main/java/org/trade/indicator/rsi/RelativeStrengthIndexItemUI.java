 ...
 * @since 1.0.4
 */
public class RelativeStrengthIndexItemUI extends ComparableObjectItem {
     ...
     */
    public RelativeStrengthIndexItemUI(RegularTimePeriod period, BigDecimal relativeStrengthIndex) {
