...
import org.trade.indicator.bollingerbands.BollingerBandsItemUI;
import org.trade.indicator.bollingerbands.IBollingerBandsDatasetUI;
 ...
 *
 */
public class BollingerBandsDatasetUI extends AbstractXYDataset
        implements IIndicatorDatasetUI, IBollingerBandsDatasetUI, Serializable {
     ...
     */
    public BollingerBandsDatasetUI() {
    ...
    public void addSeries(IndicatorSeriesUI series) {
        ...
        try {
            ((BollingerBandsSeriesUI) series).setIsUpper(true);
            this.data.add(series);
            BollingerBandsSeriesUI lowerSeries = (BollingerBandsSeriesUI) series.clone();
     ...
     */
    public BollingerBandsSeriesUI getSeries(int series) {
        if ((series < 0) || (series >= getSeriesCount())) {
            throw new IllegalArgumentException("Series index out of bounds");
        }
        return (BollingerBandsSeriesUI) this.data.get(series);
    }
    ...
    public double getXValue(int series, int item) {
        BollingerBandsSeriesUI s = (BollingerBandsSeriesUI) this.data.get(series);
        BollingerBandsItemUI di = (BollingerBandsItemUI) s.getDataItem(item);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof BollingerBandsDatasetUI that)) {
            return false;
        }
    ...
    public Object clone() throws CloneNotSupportedException {
        BollingerBandsDatasetUI clone = (BollingerBandsDatasetUI) super.clone();
    ...
    public void updateDataset(CandleDatasetUI source, int seriesIndex, boolean newBar) {
        ...
        for (int x = 0; x < this.getSeriesCount(); x++) {
            BollingerBandsSeriesUI series = this.getSeries(x);
