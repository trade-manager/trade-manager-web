...
import org.trade.indicator.cci.CommodityChannelIndexItemUI;
...
public class CommodityChannelIndexSeriesUI extends IndicatorSeriesUI {
     ...
     */
    public CommodityChannelIndexSeriesUI(Strategy strategy, String name, String type, String description,
    ...
    public CommodityChannelIndexSeriesUI() {
        super(IndicatorSeriesUI.CommodityChannelIndexSeries);
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        CommodityChannelIndexSeriesUI clone = (CommodityChannelIndexSeriesUI) super.clone();
    ...
    public RegularTimePeriod getPeriod(int index) {
        final CommodityChannelIndexItemUI item = (CommodityChannelIndexItemUI) getDataItem(index);
    ...
    public void add(RegularTimePeriod period, BigDecimal cciAverage) {
        if (!this.isEmpty()) {
            CommodityChannelIndexItemUI item0 = (CommodityChannelIndexItemUI) this.getDataItem(0);
            if (!period.getClass().equals(item0.getPeriod().getClass())) {
                throw new IllegalArgumentException("Can't mix RegularTimePeriod class types.");
            }
        }
        super.add(new CommodityChannelIndexItemUI(period, cciAverage), true);
    }
     ...
     */
    public void add(CommodityChannelIndexItemUI dataItem, boolean notify) {
        if (!this.isEmpty()) {
            CommodityChannelIndexItemUI item0 = (CommodityChannelIndexItemUI) this.getDataItem(0);
    ...
    public void printSeries() {
        for (int i = 0; i < this.getItemCount(); i++) {
            CommodityChannelIndexItemUI dataItem = (CommodityChannelIndexItemUI) this.getDataItem(i);
        ...
        if (source.getItemCount() > skip) {
            ...
            if (0 != typicalPrice) {
                ...
                if (typicalPriceValues.size() == getLength()) {
                    ...
                    // + cci + " newBar: " + newBar);
                    if (newBar) {
                        CommodityChannelIndexItemUI dataItem = new CommodityChannelIndexItemUI(candleItem.getPeriod(),
                                new BigDecimal(cci));
                        this.add(dataItem, false);

                    } else {
                        CommodityChannelIndexItemUI dataItem = (CommodityChannelIndexItemUI) this
