...
import org.trade.core.persistent.dao.series.indicator.vostro.Vostro;
 ...
 * @since 1.0.4
 */
public class VostroItemUI extends ComparableObjectItem {
     ...
     */
    public VostroItemUI(RegularTimePeriod period, BigDecimal vostro) {
