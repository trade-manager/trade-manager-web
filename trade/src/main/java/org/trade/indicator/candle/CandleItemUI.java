 ...
 * @since 1.0.4
 */
public class CandleItemUI extends ComparableObjectItem {
     ...
     */
    public CandleItemUI(Contract contract, Tradingday tradingday, RegularTimePeriod period, double open, double high,
