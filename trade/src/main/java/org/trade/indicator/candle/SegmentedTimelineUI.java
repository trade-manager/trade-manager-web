 ...
 */
public class SegmentedTimelineUI implements Timeline, Cloneable, Serializable {
     ...
     */
    private SegmentedTimelineUI baseTimeline;
     ...
     */
    public SegmentedTimelineUI(long segmentSize,
     ...
     */
    public static SegmentedTimelineUI newMondayThroughFridayTimeline() {
        SegmentedTimelineUI timeline
                = new SegmentedTimelineUI(DAY_SEGMENT_SIZE, 5, 2);
     ...
     * @return A fully initialized SegmentedTimeline.
     */
    public static SegmentedTimelineUI newFifteenMinuteTimeline() {
        SegmentedTimelineUI timeline = new SegmentedTimelineUI(
     ...
     */
    public SegmentedTimelineUI getBaseTimeline() {
     ...
     */
    public void setBaseTimeline(SegmentedTimelineUI baseTimeline) {
...
//                }
    ...
    public boolean equals(Object o) {
        if (o instanceof SegmentedTimelineUI) {
            SegmentedTimelineUI other = (SegmentedTimelineUI) o;
    ...
    public int hashCode() {
        int result = 19;
        result = 37 * result
                + Long.hashCode(this.segmentSize);
        result = 37 * result + Long.hashCode(this.startTime);
        return result;
    }
    ...
    public class Segment implements Comparable, Cloneable, Serializable {
        ...
        protected Segment(long millisecond) {
            ...
            this.segmentStart = SegmentedTimelineUI.this.startTime
                    + this.segmentNumber * SegmentedTimelineUI.this.segmentSize;
            this.segmentEnd
                    = this.segmentStart + SegmentedTimelineUI.this.segmentSize - 1;
        ...
        public long calculateSegmentNumber(long millis) {
            if (millis >= SegmentedTimelineUI.this.startTime) {
                return (millis - SegmentedTimelineUI.this.startTime)
                        / SegmentedTimelineUI.this.segmentSize;
            } else {
                return ((millis - SegmentedTimelineUI.this.startTime)
                        / SegmentedTimelineUI.this.segmentSize) - 1;
            }
        }
         ...
         */
        public Date getDate() {
            return SegmentedTimelineUI.this.getDate(this.millisecond);
        }
        ...
        public boolean equals(Object object) {
            if (object instanceof Segment other) {
        ...
        public boolean inIncludeSegments() {
            if (getSegmentNumberRelativeToGroup()
                    < SegmentedTimelineUI.this.segmentsIncluded) {
        ...
        private long getSegmentNumberRelativeToGroup() {
            long p = (this.segmentNumber
                    % SegmentedTimelineUI.this.groupSegmentCount);
            if (p < 0) {
                p += SegmentedTimelineUI.this.groupSegmentCount;
            }
            return p;
        }
        ...
        public void inc(long n) {
            ...
            long m = n * SegmentedTimelineUI.this.segmentSize;
            this.segmentStart += m;
            this.segmentEnd += m;
            this.millisecond += m;
        }
