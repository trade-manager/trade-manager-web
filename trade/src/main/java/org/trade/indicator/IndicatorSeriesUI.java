...
public abstract class IndicatorSeriesUI extends ComparableObjectSeries implements Cloneable, Serializable {

    @Serial
    private static final long serialVersionUID = -4985280367851073683L;

    protected final static Logger _log = LoggerFactory.getLogger(IndicatorSeriesUI.class);
     ...
     * @param type String
     */
    public IndicatorSeriesUI(String type) {
     ...
     */
    public IndicatorSeriesUI(String type, Boolean displaySeries, Integer seriesRGBColor, Boolean subChart) {
        super(type, true, false);
        this.type = type;
     ...
     * @param subChart       Boolean
     */
    public IndicatorSeriesUI(String name, String type, Boolean displaySeries, Integer seriesRGBColor, Boolean subChart) {
     ...
     * @param subChart       Boolean
     */
    public IndicatorSeriesUI(Strategy strategy, String name, String type, String description, Boolean displaySeries,
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        IndicatorSeriesUI clone = (IndicatorSeriesUI) super.clone();
     ...
     */
    public abstract void updateSeries(CandleSeriesUI source, int skip, boolean newBar);
     ...
     */
    public abstract void createSeries(CandleDatasetUI source, int seriesIndex);
