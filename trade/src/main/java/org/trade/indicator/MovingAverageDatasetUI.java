...
import org.trade.indicator.movingaverage.IMovingAverageDatasetUI;
import org.trade.indicator.movingaverage.MovingAverageItemUI;
 ...
 *
 */
public class MovingAverageDatasetUI extends AbstractXYDataset
        implements IIndicatorDatasetUI, IMovingAverageDatasetUI, Serializable {
     ...
     */
    public MovingAverageSeriesUI getSeries(int series) {
        if ((series < 0) || (series >= getSeriesCount())) {
            throw new IllegalArgumentException("Series index out of bounds");
        }
        return (MovingAverageSeriesUI) this.data.get(series);
    }
    ...
    public double getXValue(int series, int item) {
        MovingAverageSeriesUI s = (MovingAverageSeriesUI) this.data.get(series);
        MovingAverageItemUI di = (MovingAverageItemUI) s.getDataItem(item);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MovingAverageDatasetUI that)) {
            return false;
        }
    ...
    public Object clone() throws CloneNotSupportedException {
        MovingAverageDatasetUI clone = (MovingAverageDatasetUI) super.clone();
    ...
    public void updateDataset(CandleDatasetUI source, int seriesIndex, boolean newBar) {
        ...
        for (int x = 0; x < this.getSeriesCount(); x++) {
            MovingAverageSeriesUI series = this.getSeries(x);
