...
import org.trade.indicator.stochasticoscillator.IStochasticOscillatorDatasetUI;
 ...
 *
 */
public class StochasticOscillatorDatasetUI extends AbstractXYDataset
        implements IIndicatorDatasetUI, IStochasticOscillatorDatasetUI, Serializable {
     ...
     */
    public StochasticOscillatorDatasetUI() {
     ...
     * @see IIndicatorDatasetUI#getSeries(int)
     */
    public StochasticOscillatorSeriesUI getSeries(int series) {
        if ((series < 0) || (series >= getSeriesCount())) {
            throw new IllegalArgumentException("Series index out of bounds");
        }
        return (StochasticOscillatorSeriesUI) this.data.get(series);
    }
     ...
     * @throws IllegalArgumentException if <code>series</code> is not in the specified range.
    ...
    public double getXValue(int series, int item) {
        StochasticOscillatorSeriesUI s = (StochasticOscillatorSeriesUI) this.data.get(series);
        StochasticOscillatorItemUI di = (StochasticOscillatorItemUI) s.getDataItem(item);
     ...
     * @see IStochasticOscillatorDatasetUI
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof StochasticOscillatorDatasetUI that)) {
            return false;
        }
    ...
    public Object clone() throws CloneNotSupportedException {
        StochasticOscillatorDatasetUI clone = (StochasticOscillatorDatasetUI) super.clone();
    ...
    public void updateDataset(CandleDatasetUI source, int seriesIndex, boolean newBar) {
        ...
        for (int x = 0; x < this.getSeriesCount(); x++) {
            StochasticOscillatorSeriesUI series = this.getSeries(x);
