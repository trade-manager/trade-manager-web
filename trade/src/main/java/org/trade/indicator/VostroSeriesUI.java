...
public class VostroSeriesUI extends IndicatorSeriesUI {
     ...
     */
    public VostroSeriesUI(Strategy strategy, String name, String type, String description, Boolean displayOnChart,
    ...
    public Object clone() throws CloneNotSupportedException {
        VostroSeriesUI clone = (VostroSeriesUI) super.clone();
    ...
    public RegularTimePeriod getPeriod(int index) {
        final VostroItemUI item = (VostroItemUI) getDataItem(index);
    ...
    public void add(RegularTimePeriod period, BigDecimal vostro) {
        if (!this.isEmpty()) {
            VostroItemUI item0 = (VostroItemUI) this.getDataItem(0);
            if (!period.getClass().equals(item0.getPeriod().getClass())) {
                throw new IllegalArgumentException("Can't mix RegularTimePeriod class types.");
            }
        }
        super.add(new VostroItemUI(period, vostro), true);
    }
     ...
     */
    public void add(VostroItemUI dataItem, boolean notify) {
        if (!this.isEmpty()) {
            VostroItemUI item0 = (VostroItemUI) this.getDataItem(0);
        ...
        if (source.getItemCount() > skip) {
            ...
            if (0 != this.getPrice(candleItem)) {
                ...
                if (this.yyValues.size() == getLength()) {
                    ...
                    if (newBar) {
                        VostroItemUI dataItem = new VostroItemUI(candleItem.getPeriod(), new BigDecimal(vostro));
                        this.add(dataItem, false);

                    } else {
                        VostroItemUI dataItem = (VostroItemUI) this.getDataItem(this.getItemCount() - 1);
    ...
    public void printSeries() {
        for (int i = 0; i < this.getItemCount(); i++) {
            VostroItemUI dataItem = (VostroItemUI) this.getDataItem(i);
