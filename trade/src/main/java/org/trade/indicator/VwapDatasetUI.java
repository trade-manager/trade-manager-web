...
import org.trade.indicator.vwap.IVwapDatasetUI;
 ...
 *
 */
public class VwapDatasetUI extends AbstractXYDataset implements IVwapDatasetUI, IIndicatorDatasetUI, Serializable {
     ...
     */
    public VwapSeriesUI getSeries(int series) {
        if ((series < 0) || (series >= getSeriesCount())) {
            throw new IllegalArgumentException("Series index out of bounds");
        }
        return (VwapSeriesUI) this.data.get(series);
    }
    ...
    public double getXValue(int series, int item) {
        VwapSeriesUI s = (VwapSeriesUI) this.data.get(series);
        VwapItemUI di = (VwapItemUI) s.getDataItem(item);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof VwapDatasetUI that)) {
            return false;
        }
    ...
    public Object clone() throws CloneNotSupportedException {
        VwapDatasetUI clone = (VwapDatasetUI) super.clone();
    ...
    public void updateDataset(CandleDatasetUI source, int seriesIndex, boolean newBar) {
        ...
        for (int i = 0; i < this.getSeriesCount(); i++) {
            VwapSeriesUI series = this.getSeries(i);
