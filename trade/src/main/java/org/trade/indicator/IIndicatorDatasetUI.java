 ...
 */
public interface IIndicatorDatasetUI {
     ...
     */
    void updateDataset(CandleDatasetUI source, int seriesIndex, boolean newBar);
     ...
     */
    IndicatorSeriesUI getSeries(int seriesIndex);
     ...
     */
    void addSeries(IndicatorSeriesUI series);
     ...
     * @param series IndicatorSeries
     */
    void removeSeries(IndicatorSeriesUI series);
     ...
     * @param series IndicatorSeries
     */
    void setSeries(int index, IndicatorSeriesUI series);
