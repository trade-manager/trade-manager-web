...
import org.trade.indicator.macd.IMACDDatasetUI;
 ...
 *
 */
public class MACDDatasetUI extends AbstractXYDataset implements IIndicatorDatasetUI, IMACDDatasetUI, Serializable {
     ...
     */
    public MACDSeriesUI getSeries(int series) {
        if ((series < 0) || (series >= getSeriesCount())) {
            throw new IllegalArgumentException("Series index out of bounds");
        }
        return (MACDSeriesUI) this.data.get(series);
    }
    ...
    public double getXValue(int series, int item) {
        MACDSeriesUI s = (MACDSeriesUI) this.data.get(series);
        MACDItemUI di = (MACDItemUI) s.getDataItem(item);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MACDDatasetUI that)) {
            return false;
        }
    ...
    public Object clone() throws CloneNotSupportedException {
        MACDDatasetUI clone = (MACDDatasetUI) super.clone();
    ...
    public void updateDataset(CandleDatasetUI source, int seriesIndex, boolean newBar) {
        ...
        for (int x = 0; x < this.getSeriesCount(); x++) {
            MACDSeriesUI series = this.getSeries(x);
