...
import org.trade.indicator.vostro.IVostroDatasetUI;
import org.trade.indicator.vostro.VostroItemUI;
 ...
 *
 */
public class VostroDatasetUI extends AbstractXYDataset implements IIndicatorDatasetUI, IVostroDatasetUI, Serializable {
     ...
     */
    public VostroSeriesUI getSeries(int series) {
        if ((series < 0) || (series >= getSeriesCount())) {
            throw new IllegalArgumentException("Series index out of bounds");
        }
        return (VostroSeriesUI) this.data.get(series);
    }
    ...
    public double getXValue(int series, int item) {
        VostroSeriesUI s = (VostroSeriesUI) this.data.get(series);
        VostroItemUI di = (VostroItemUI) s.getDataItem(item);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof VostroDatasetUI that)) {
            return false;
        }
    ...
    public Object clone() throws CloneNotSupportedException {
        VostroDatasetUI clone = (VostroDatasetUI) super.clone();
    ...
    public void updateDataset(CandleDatasetUI source, int seriesIndex, boolean newBar) {
        ...
        for (int x = 0; x < this.getSeriesCount(); x++) {
            VostroSeriesUI series = this.getSeries(x);
