...
import org.trade.indicator.pivot.IPivotDatasetUI;
 ...
 *
 */
public class PivotDatasetUI extends AbstractXYDataset implements IIndicatorDatasetUI, IPivotDatasetUI, Serializable {
     ...
     */
    public PivotSeriesUI getSeries(int series) {
        if ((series < 0) || (series >= getSeriesCount())) {
            throw new IllegalArgumentException("Series index out of bounds");
        }
        return (PivotSeriesUI) this.data.get(series);
    }
    ...
    public double getXValue(int series, int item) {
        PivotSeriesUI s = (PivotSeriesUI) this.data.get(series);
        PivotItemUI di = (PivotItemUI) s.getDataItem(item);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof PivotDatasetUI that)) {
            return false;
        }
    ...
    public Object clone() throws CloneNotSupportedException {
        PivotDatasetUI clone = (PivotDatasetUI) super.clone();
    ...
    public void updateDataset(CandleDatasetUI source, int seriesIndex, boolean newBar) {
        ...
        for (int i = 0; i < this.getSeriesCount(); i++) {
            PivotSeriesUI series = this.getSeries(i);
