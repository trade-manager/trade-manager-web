 ...
 */
public class MACDSeriesUI extends IndicatorSeriesUI {
     ...
     */
    public MACDSeriesUI(Strategy strategy, String name, String type, String description, Boolean displayOnChart,
    ...
    public MACDSeriesUI() {
        super(IndicatorSeriesUI.MACDSeries);
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        MACDSeriesUI clone = (MACDSeriesUI) super.clone();
    ...
    public RegularTimePeriod getPeriod(int index) {
        final MACDItemUI item = (MACDItemUI) getDataItem(index);
    ...
    public void add(RegularTimePeriod period, BigDecimal MACD, BigDecimal signalLine, BigDecimal MACDHistogram) {
        if (!this.isEmpty()) {
            MACDItemUI item0 = (MACDItemUI) this.getDataItem(0);
            if (!period.getClass().equals(item0.getPeriod().getClass())) {
                throw new IllegalArgumentException("Can't mix RegularTimePeriod class types.");
            }
        }
        super.add(new MACDItemUI(period, MACD, signalLine, MACDHistogram), true);
    }
     ...
     */
    public void add(MACDItemUI dataItem, boolean notify) {
        if (!this.isEmpty()) {
            MACDItemUI item0 = (MACDItemUI) this.getDataItem(0);
    ...
    public void updateSeries(CandleSeriesUI source, int skip, boolean newBar) {
        ...
        if (source.getItemCount() > skip) {
            ...
            if (this.slowYYValues.size() == getSlowLength()) {
                ...
                if (newBar) {
                    MACDItemUI dataItem = new MACDItemUI(candleItem.getPeriod(), new BigDecimal(MACD),
                    ...
                    MACDItemUI dataItem = (MACDItemUI) this.getDataItem(this.getItemCount() - 1);
    ...
    public void printSeries() {
        for (int i = 0; i < this.getItemCount(); i++) {
            MACDItemUI dataItem = (MACDItemUI) this.getDataItem(i);
