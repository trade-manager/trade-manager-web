 ...
 * @since 1.0.4
 */
public class MACDItemUI extends ComparableObjectItem {
     ...
     */
    public MACDItemUI(RegularTimePeriod period, BigDecimal MACD, BigDecimal signalLine, BigDecimal MACDHistogram) {
