...
import org.trade.indicator.volume.IVolumeDatasetUI;
 ...
 *
 */
public class VolumeDatasetUI extends AbstractIntervalXYDataset implements IVolumeDatasetUI, IIndicatorDatasetUI, Serializable {
     ...
     */
    public VolumeSeriesUI getSeries(int series) {
        if ((series < 0) || (series >= getSeriesCount())) {
            throw new IllegalArgumentException("Series index out of bounds");
        }
        return (VolumeSeriesUI) this.data.get(series);
    }
    ...
    public double getXValue(int series, int item) {
        VolumeSeriesUI s = (VolumeSeriesUI) this.data.get(series);
        VolumeItemUI di = (VolumeItemUI) s.getDataItem(item);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof VolumeDatasetUI that)) {
            return false;
        }
    ...
    public Object clone() throws CloneNotSupportedException {
        VolumeDatasetUI clone = (VolumeDatasetUI) super.clone();
    ...
    public void updateDataset(CandleDatasetUI source, int seriesIndex, boolean newBar) {
        ...
        for (int i = 0; i < this.getSeriesCount(); i++) {
            VolumeSeriesUI series = this.getSeries(i);
