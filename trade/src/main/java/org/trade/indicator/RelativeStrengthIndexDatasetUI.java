...
import org.trade.indicator.rsi.IRelativeStrengthIndexDatasetUI;
import org.trade.indicator.rsi.RelativeStrengthIndexItemUI;
 ...
 *
 */
public class RelativeStrengthIndexDatasetUI extends AbstractXYDataset
        implements IIndicatorDatasetUI, IRelativeStrengthIndexDatasetUI, Serializable {
     ...
     */
    public RelativeStrengthIndexDatasetUI() {
     ...
     */
    public RelativeStrengthIndexSeriesUI getSeries(int series) {
        if ((series < 0) || (series >= getSeriesCount())) {
            throw new IllegalArgumentException("Series index out of bounds");
        }
        return (RelativeStrengthIndexSeriesUI) this.data.get(series);
    }
    ...
    public double getXValue(int series, int item) {
        RelativeStrengthIndexSeriesUI s = (RelativeStrengthIndexSeriesUI) this.data.get(series);
        RelativeStrengthIndexItemUI di = (RelativeStrengthIndexItemUI) s.getDataItem(item);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof RelativeStrengthIndexDatasetUI that)) {
            return false;
        }
    ...
    public Object clone() throws CloneNotSupportedException {
        RelativeStrengthIndexDatasetUI clone = (RelativeStrengthIndexDatasetUI) super.clone();
    ...
    public void updateDataset(CandleDatasetUI source, int seriesIndex, boolean newBar) {
        ...
        for (int x = 0; x < this.getSeriesCount(); x++) {
            RelativeStrengthIndexSeriesUI series = this.getSeries(x);
