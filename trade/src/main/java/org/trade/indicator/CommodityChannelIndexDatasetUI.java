...
import org.trade.indicator.cci.ICommodityChannelIndexDatasetUI;
 ...
 *
 */
public class CommodityChannelIndexDatasetUI extends AbstractXYDataset
        implements IIndicatorDatasetUI, ICommodityChannelIndexDatasetUI, Serializable {
     ...
     */
    public CommodityChannelIndexDatasetUI() {
     ...
     */
    public CommodityChannelIndexSeriesUI getSeries(int series) {
        if ((series < 0) || (series >= getSeriesCount())) {
            throw new IllegalArgumentException("Series index out of bounds");
        }
        return (CommodityChannelIndexSeriesUI) this.data.get(series);
    }
    ...
    public double getXValue(int series, int item) {
        CommodityChannelIndexSeriesUI s = (CommodityChannelIndexSeriesUI) this.data.get(series);
        CommodityChannelIndexItemUI di = (CommodityChannelIndexItemUI) s.getDataItem(item);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CommodityChannelIndexDatasetUI that)) {
            return false;
        }
    ...
    public Object clone() throws CloneNotSupportedException {
        CommodityChannelIndexDatasetUI clone = (CommodityChannelIndexDatasetUI) super.clone();
    ...
    public void updateDataset(CandleDatasetUI source, int seriesIndex, boolean newBar) {
        ...
        for (int x = 0; x < this.getSeriesCount(); x++) {
            CommodityChannelIndexSeriesUI series = this.getSeries(x);
