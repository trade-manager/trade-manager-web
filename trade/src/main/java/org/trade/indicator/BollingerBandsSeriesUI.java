 ...
 */
public class BollingerBandsSeriesUI extends IndicatorSeriesUI {
     ...
     */
    public BollingerBandsSeriesUI(Strategy strategy, String name, String type, String description, Boolean displayOnChart,
    ...
    public BollingerBandsSeriesUI() {
        super(IndicatorSeriesUI.BollingerBandsSeries);
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        BollingerBandsSeriesUI clone = (BollingerBandsSeriesUI) super.clone();
    ...
    public RegularTimePeriod getPeriod(int index) {
        final BollingerBandsItemUI item = (BollingerBandsItemUI) getDataItem(index);
    ...
    public void add(RegularTimePeriod period, BigDecimal bollingerBands) {
        if (!this.isEmpty()) {
            BollingerBandsItemUI item0 = (BollingerBandsItemUI) this.getDataItem(0);
            if (!period.getClass().equals(item0.getPeriod().getClass())) {
                throw new IllegalArgumentException("Can't mix RegularTimePeriod class types.");
            }
        }
        super.add(new BollingerBandsItemUI(period, bollingerBands), true);
    }
     ...
     */
    public void add(BollingerBandsItemUI dataItem, boolean notify) {
        if (!this.isEmpty()) {
            BollingerBandsItemUI item0 = (BollingerBandsItemUI) this.getDataItem(0);
    ...
    public void updateSeries(CandleSeriesUI source, int skip, boolean newBar) {
        ...
        if (source.getItemCount() > skip) {
            ...
            if (this.yyValues.size() == getLength()) {
                ...
                if (newBar) {
                    BollingerBandsItemUI dataItem = new BollingerBandsItemUI(candleItem.getPeriod(),
                            new BigDecimal(ma));
                    this.add(dataItem, false);

                } else {
                    BollingerBandsItemUI dataItem = (BollingerBandsItemUI) this.getDataItem(this.getItemCount() - 1);
