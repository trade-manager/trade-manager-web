...
public class VolumeSeriesUI extends IndicatorSeriesUI {
    ...
    public VolumeSeriesUI(Strategy strategy, String name, String type, String description, Boolean displayOnChart,
    ...
    public VolumeSeriesUI() {
        super(IndicatorSeriesUI.VolumeSeries);
    }
    ...
    public RegularTimePeriod getPeriod(int index) {
        final VolumeItemUI item = (VolumeItemUI) getDataItem(index);
    ...
    public void add(RegularTimePeriod period, Long volume, boolean side) {
        ...
        super.add(new VolumeItemUI(period, volume, side), true);
    }
    ...
    public void updateSeries(CandleSeriesUI source, int skip, boolean newBar) {
        ...
        if (source.getItemCount() > skip) {
             ...
             */
            if (newBar) {
                VolumeItemUI dataItem = new VolumeItemUI(candleItem.getPeriod(), candleItem.getVolume(),
                        candleItem.getSide());
                this.add(dataItem, true);
            } else {
                VolumeItemUI dataItem = (VolumeItemUI) this.getDataItem(this.getItemCount() - 1);
    ...
    public void printSeries() {
        for (int i = 0; i < this.getItemCount(); i++) {
            VolumeItemUI dataItem = (VolumeItemUI) this.getDataItem(i);
