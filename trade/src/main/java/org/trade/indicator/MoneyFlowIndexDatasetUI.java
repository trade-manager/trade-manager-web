...
import org.trade.indicator.mfi.IMoneyFlowIndexDatasetUI;
 ...
 *
 */
public class MoneyFlowIndexDatasetUI extends AbstractXYDataset
        implements IIndicatorDatasetUI, IMoneyFlowIndexDatasetUI, Serializable {
     ...
     */
    public MoneyFlowIndexDatasetUI() {
     ...
     */
    public MoneyFlowIndexSeriesUI getSeries(int series) {
        if ((series < 0) || (series >= getSeriesCount())) {
            throw new IllegalArgumentException("Series index out of bounds");
        }
        return (MoneyFlowIndexSeriesUI) this.data.get(series);
    }
    ...
    public double getXValue(int series, int item) {
        MoneyFlowIndexSeriesUI s = (MoneyFlowIndexSeriesUI) this.data.get(series);
        MoneyFlowIndexItemUI di = (MoneyFlowIndexItemUI) s.getDataItem(item);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MoneyFlowIndexDatasetUI that)) {
            return false;
        }
    ...
    public Object clone() throws CloneNotSupportedException {
        MoneyFlowIndexDatasetUI clone = (MoneyFlowIndexDatasetUI) super.clone();
    ...
    public void updateDataset(CandleDatasetUI source, int seriesIndex, boolean newBar) {
        ...
        for (int x = 0; x < this.getSeriesCount(); x++) {
            MoneyFlowIndexSeriesUI series = this.getSeries(x);
