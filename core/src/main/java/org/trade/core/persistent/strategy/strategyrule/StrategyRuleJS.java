...
public class StrategyRuleJS extends AbstractStrategyRule {
    ...
    public JSONObject getOpenTradePositionJSON() {
        ...
        try {
            ...
            TradePositionRecord tradePositionRecord = TradePositionRecord.from(tradePosition);

            if (null != tradePositionRecord) {

                result.put("data", new JSONObject(JSONMapper.getJSONString(tradePositionRecord)));
            } else {
    ...
    public JSONObject getOpenPositionOrderJSON() {
        ...
        try {
            ...
            if (null != tradeOrderRecord) {

                result.put("data", new JSONObject(JSONMapper.getJSONString(tradeOrderRecord)));
            } else {
    ...
    public JSONObject createStopAndTargetOrder(Object openPosition, final Integer stopRiskUnits,
        ...
        try {
            ...
            TradeOrderRecord tradeOrderRecord = JSONMapper.getRecord(tradeOrderJSON.toString(), TradeOrderRecord.class);
            TradeOrder tradeOrder = JSONMapper.convertRecordToEntity(tradeOrderRecord, TradeOrder.class);
    ...
    public JSONObject getInitParams() {
        ...
        try {
            ...
            List<Decode> indicatorSeriesCodes = IndicatorSeriesUI.newInstance().getCodesDecodes();
