 ...
 */
@Service
public class TradelogSummaryServiceImpl implements TradelogSummaryService {
    ...
    private final TradelogSummaryRepository tradelogSummaryRepository;

    public TradelogSummaryServiceImpl(final TradelogSummaryRepository tradelogSummaryRepository) {

        this.tradelogSummaryRepository = tradelogSummaryRepository;
    }
