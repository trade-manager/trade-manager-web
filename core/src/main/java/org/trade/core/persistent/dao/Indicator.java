...
public abstract class Indicator extends Aspect implements Cloneable, Serializable {

    @Serial
    private static final long serialVersionUID = -4985280367851073683L;

    protected final static Logger _log = LoggerFactory.getLogger(Indicator.class);
     ...
     */
    public Indicator(String type, Boolean displaySeries, Integer seriesRGBColor, Boolean subChart) {
        this.type = type;
     ...
     * @param subChart       Boolean
     */
    public Indicator(String name, String type, Boolean displaySeries, Integer seriesRGBColor, Boolean subChart) {
        this.type = type;
        this.displaySeries = displaySeries;
        this.seriesRGBColor = seriesRGBColor;
        this.subChart = subChart;
     ...
     * @param subChart       Boolean
     */
    public Indicator(Strategy strategy, String name, String type, String description, Boolean displaySeries,
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        Indicator clone = (Indicator) super.clone();
     ...
     */
    public abstract void updateSeries(LinkedList<Candle> source, int skip, boolean newBar);
     ...
     */
    public abstract void createSeries(LinkedList<Candle> source, int seriesIndex);
