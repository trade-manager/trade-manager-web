...
public record TradestrategyRecord(Long id,
    ...
    public static TradestrategyRecord from(Tradestrategy tradestrategy) {
        ...
        return new TradestrategyRecord(
                ...
                (null == tradestrategy.getStrategy() ? null : StrategyRecord.from(tradestrategy.getStrategy(), false)),
                (null == tradestrategy.getPortfolio() ? null : PortfolioRecord.from(tradestrategy.getPortfolio(), false)),
