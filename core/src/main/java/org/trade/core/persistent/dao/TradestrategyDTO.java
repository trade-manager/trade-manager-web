...
public class TradestrategyDTO extends Aspect implements Serializable, Cloneable {
     ...
     * @param portfolio PortfolioDto
     */
    public void setPortfolio(PortfolioRecord portfolio) {
        this.portfolio = portfolio;
    }
    ...
    public static final Comparator<TradestrategyDTO> TRADINGDAY_CONTRACT = (o1, o2) -> {
        ...
        if (CoreUtils.nullSafeComparator(o1.getTradingday().open(), o2.getTradingday().open()) == 0) {
            ...
            if (o1.getContract().equals(o2.getContract())) {
                ...
                returnVal = o1.getContract().symbol().compareTo(o2.getContract().symbol());
            }
    ...
    public String toString() {
        ...
        return this.getContract().symbol().toUpperCase();
    }
